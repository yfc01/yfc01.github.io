...
以 <a href="https://github.com/dsrkafuu/sakana-widget.git" target="_blank">PaperMod</a> 项目为例，在 `layouts/_default/baseof.html` 文件中添加如下代码，以全局加载 JS 文件：
